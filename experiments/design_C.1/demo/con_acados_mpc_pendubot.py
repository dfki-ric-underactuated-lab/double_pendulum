...
from parameters import dt, t_final, goal, x0, model_par_path
...
controller = AcadosMpc(
    model_pars=mpar, generate_code_filename="double_pendulum_pendubot"
)
# dt = 0.001
