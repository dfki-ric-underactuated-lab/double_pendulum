...
class CustomEnv(gym.Env):
    def __init__(
        ...
        self.step_counter = 0
        # scaling means normalizing from physical environment parameters to [-1,1]
        self.scaling = scaling

    def step(self,action):
        """
        This function is for taking a step in the environment
        Parameters
        ----------
        action : input torque
    ...
    def render(self,mode="human"):
        # we don't use inbuilt render function
        pass
