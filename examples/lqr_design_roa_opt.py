...
from double_pendulum.controller.lqr.roa_paropt import roa_modelpar_lossfunc
...
loss_func.set_cost_parameters(p1p1_cost=16.50,
                              p2p2_cost=90.94,
                              v1v1_cost=0.07,
                              v2v2_cost=0.01,
                              p1v1_cost=0.,
...
Q = np.diag((16.50, 90.94, 0.07, 0.01))
R = np.diag((3.65, 3.65))
